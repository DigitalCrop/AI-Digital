...
export type ConditionField = 'RSI' | 'MACD' | 'EMA' | 'SMA' | 'VWAP' | 'PRICE' | 'VOLUME' | 'DELIVERY_PCT' | 'BREAKOUT' | 'MOMENTUM' | 'STOP_LOSS' | 'TARGET';
...
export type WSEventType = 'quote_update' | 'order_update' | 'trade_executed' | 'signal_generated' | 'alert' | 'emergency_stop' | 'portfolio_update';
...
export type AuditAction = 'LOGIN' | 'LOGOUT' | 'ORDER_PLACED' | 'ORDER_MODIFIED' | 'ORDER_CANCELLED' | 'STRATEGY_CREATED' | 'STRATEGY_ACTIVATED' | 'STRATEGY_STOPPED' | 'EMERGENCY_STOP' | 'BROKER_CONNECTED' | 'BROKER_DISCONNECTED' | 'SETTINGS_UPDATED' | 'TRADE_EXECUTED';
